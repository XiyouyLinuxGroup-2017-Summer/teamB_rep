...
void do_cmd(int argcount, char arglist[100][256],int *history_count,char history[][256],char *path);                   //　执行命令　　
...
int  main(int argc , char **argv)
{
    ...
    */
        do_cmd(argcount, arglist,&history_count,history,path);
    }
...
void do_cmd(int argcount, char arglist[100][256],int *   history_count,char  history[][256],char *path)
{
    int     flag = 0;
